...
(function (global) {
  ...
  const EN = {
    ...
    'nav.businessMail': '✉️ Business Mail',
    'mail.title': '✉️ Business Mail',
    'mail.hint': 'Send payment reminders, invoices and quotes from your shop name. Track sent mail and log customer replies — all in one place.',
    'mail.replyEmail': 'Reply-to email (customers reply here)',
