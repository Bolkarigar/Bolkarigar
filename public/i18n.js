...
(function (global) {
  ...
  const EN = {
    ...
    'nav.estimate': '📋 Estimate / Quote',
    'estimate.title': '📋 Quotation / Estimate Builder',
    'estimate.hint': 'Share a PDF estimate with your client before starting work. When they accept, convert to invoice in one click.',
    ...
    'businessCard.hint': 'Select a card → fill details → Download or share on WhatsApp. Pro: 18 unique designs · Business: 30 luxury cards.',
    'businessCard.freeTab': '⭐ Pro Plan — 18 Cards',
    'businessCard.premiumTab': '👑 Business — 30 Luxury',
    ...
    'paywall.desc': 'Your free trial has ended. Renew — Pro ₹99/mo or ₹999/yr · Business ₹299/mo or ₹2999/yr.',
  ...
  const HI = {
    ...
    'nav.estimate': '📋 एस्टीमेट / कोट',
    'estimate.title': '📋 कोटेशन / एस्टीमेट',
    'estimate.hint': 'Kaam se pehle client ko PDF estimate bhejein — accept par ek click se Invoice.',
    ...
    'businessCard.hint': 'कार्ड चुनें → details भरें → Download या WhatsApp पर share करें। Pro: 18 unique designs · Business: 30 luxury cards।',
    'businessCard.freeTab': '⭐ Pro Plan — 18 Cards',
    'businessCard.premiumTab': '👑 Business — 30 Luxury',
    'businessCard.personalDetails': 'Personal Details',
